    ...
    public static class ResendEmailConfirmationEmail
    {
        ...
        public sealed class Handler : IRequestHandler<Query,Unit>
        {
            ...
            public async Task<Unit> Handle(Query request, CancellationToken cancellationToken)
            {
                ...
                await _EmailSender.SendEmailConfirmationEmailAsync(currentUser.Email, emailConfiramtionToken, currentUser.Id,Domain.Enums.EmailType.ConfirmAccount ,cancellationToken);

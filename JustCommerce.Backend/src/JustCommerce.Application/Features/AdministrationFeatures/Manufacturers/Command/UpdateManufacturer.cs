...
using JustCommerce.Application.Common.Factories.DtoFactories.Manufacturer;
...
namespace JustCommerce.Application.Features.AdministrationFeatures.Manufacturers.Command
{

...
namespace JustCommerce.Application.Common.Interfaces
{
    public interface IMailSender
    {
        ...
        Task SendEmailConfirmationEmailAsync(string reciverEmail, string emailConfirmationToken, Guid userId, EmailType emailType, CancellationToken cancellationToken = default);

...
{
    public sealed class ProductAttributeValueDTO : Entity 
    {
        /// <summary>
        ...
        public ICollection<ProductAttributeValueLangDTO> ProductAttributeValueLang { get; set; } = new List<ProductAttributeValueLangDTO>();

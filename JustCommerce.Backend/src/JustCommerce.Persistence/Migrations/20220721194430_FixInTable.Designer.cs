...
namespace JustCommerce.Persistence.Migrations
{
    ...
    [Migration("20220721194430_FixInTable")]
    partial class FixInTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JustCommerce.Domain.Entities.Products.Category.CategoryEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JustCommerce.Domain.Entities.Products.Category.CategoryLangEntity", b =>
                {
                    ...
                    b.ToTable("CategoryLang", "product");
                });

            modelBuilder.Entity("JustCommerce.Domain.Entities.Products.Category.ProductCategoryEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JustCommerce.Domain.Entities.Products.Manufacturer.ManufacturerEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Manufacturer", "product");
                });

            modelBuilder.Entity("JustCommerce.Domain.Entities.Products.Manufacturer.ManufacturerLangEntity", b =>
                {
                    ...
                    b.ToTable("ManufacturerLang", "product");
                });

            modelBuilder.Entity("JustCommerce.Domain.Entities.Products.Manufacturer.ProductManufacturerEntity", b =>
                {
                    b.Property<Guid>("ProductId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProductManufacturer", "product");
                });
            ...
            modelBuilder.Entity("JustCommerce.Domain.Entities.Products.Product.ProductLangEntity", b =>
                {
                    b.Property<Guid>("ProductId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JustCommerce.Domain.Entities.Products.Product.RelatedProductEntity", b =>
                {
                    ...
                    b.ToTable("RelatedProduct", "product");
                });
            ...
            modelBuilder.Entity("JustCommerce.Domain.Entities.Products.Category.CategoryEntity", b =>
                {
                    b.HasOne("JustCommerce.Domain.Entities.Products.Category.CategoryEntity", "ParentCategory")
            ...
            modelBuilder.Entity("JustCommerce.Domain.Entities.Products.Category.CategoryLangEntity", b =>
                {
                    b.HasOne("JustCommerce.Domain.Entities.Products.Category.CategoryEntity", "Category")
            ...
            modelBuilder.Entity("JustCommerce.Domain.Entities.Products.Manufacturer.ManufacturerLangEntity", b =>
                {
                    ...
                    b.HasOne("JustCommerce.Domain.Entities.Products.Manufacturer.ManufacturerEntity", "Manufacturer")
                        .WithMany("ManufacturerLang")
            ...
            modelBuilder.Entity("JustCommerce.Domain.Entities.Products.Product.RelatedProductEntity", b =>
                {
                    b.HasOne("JustCommerce.Domain.Entities.Products.Product.ProductEntity", "Product1")
                        .WithMany()
                        .HasForeignKey("Product1Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("JustCommerce.Domain.Entities.Products.Product.ProductEntity", "Product2")
                        .WithMany()

...
namespace JustCommerce.Persistence.Migrations
{
    ...
    [Migration("20220704065713_Migration_Fix_String_LanguageId_To_Guid")]
    partial class Migration_Fix_String_LanguageId_To_Guid
    {
            ...
            modelBuilder.Entity("JustCommerce.Domain.Entities.Category.CategoryLangEntity", b =>
                {
                    ...
                    b.HasOne("JustCommerce.Domain.Entities.Language.LanguageEntity", "Language")
                        .WithOne()
                        .HasForeignKey("JustCommerce.Domain.Entities.Category.CategoryLangEntity", "LanguageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("JustCommerce.Domain.Entities.Product.ProductLangEntity", b =>
                {
                    b.HasOne("JustCommerce.Domain.Entities.Language.LanguageEntity", "Language")
                        .WithOne()
                        .HasForeignKey("JustCommerce.Domain.Entities.Product.ProductLangEntity", "LanguageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("JustCommerce.Domain.Entities.ProductType.ProductTypePropertyLangEntity", b =>
                {
                    b.HasOne("JustCommerce.Domain.Entities.Language.LanguageEntity", "Language")
                        .WithOne()
                        .HasForeignKey("JustCommerce.Domain.Entities.ProductType.ProductTypePropertyLangEntity", "LanguageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

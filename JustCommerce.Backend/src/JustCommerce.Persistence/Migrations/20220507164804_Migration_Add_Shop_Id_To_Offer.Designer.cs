...
namespace JustCommerce.Persistence.Migrations
{
    ...
    [Migration("20220507164804_Migration_Add_Shop_Id_To_Offer")]
    partial class Migration_Add_Shop_Id_To_Offer
    {
            ...
            modelBuilder.Entity("JustCommerce.Domain.Entities.Company.ShopEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Poznan",
                            Country = "Poland",
                            CreatedDate = new DateTime(2022, 5, 7, 18, 47, 58, 638, DateTimeKind.Local).AddTicks(6300),
                        ...
                        new
                        {
                            ...
                            City = "Przytoczna",
                            Country = "Poland",
                            CreatedDate = new DateTime(2022, 5, 7, 18, 47, 58, 638, DateTimeKind.Local).AddTicks(6422),
            ...
            modelBuilder.Entity("JustCommerce.Domain.Entities.Language.LanguageEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 5, 7, 18, 47, 58, 542, DateTimeKind.Local).AddTicks(9582),
                            IsoCode = "PL-pl",
                            Name = "Poland"
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 5, 7, 18, 47, 58, 547, DateTimeKind.Local).AddTicks(3915),
                            IsoCode = "EN-en",
                            Name = "English"
                        });
                });
            ...
            modelBuilder.Entity("JustCommerce.Domain.Entities.ProductType.ProductTypeEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 5, 7, 18, 47, 58, 611, DateTimeKind.Local).AddTicks(6332),
                            Name = "Pojemniki",
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 5, 7, 18, 47, 58, 611, DateTimeKind.Local).AddTicks(6437),
                            Name = "Regały",
                            ShopId = new Guid("6cef7328-534d-4699-98af-8779fba7d3a1")
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 5, 7, 18, 47, 58, 611, DateTimeKind.Local).AddTicks(6443),
                            Name = "Maty",
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 5, 7, 18, 47, 58, 611, DateTimeKind.Local).AddTicks(6448),
                            Name = "Drzwi",
                            ShopId = new Guid("83e84e94-b1ee-4cbf-be40-daea69347600")
                        });
                });

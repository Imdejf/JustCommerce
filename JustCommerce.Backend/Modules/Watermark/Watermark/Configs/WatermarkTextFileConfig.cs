...
{
    public sealed class WatermarkTextFileConfig : CommonConfig
    {
        /// <summary>
        ...
        private WatermarkOperation _operation = WatermarkOperation.AddText;
        /// <summary>
        ...
        public WatermarkTextFileConfig()
        {
            this.Margin = 20;
            this.Opacity = 0.5f;
            this.FontSize = 20;
            this.Operation = WatermarkOperation.AddText;
            this.ImageWatermark = File.ReadAllBytes(Directory.GetCurrentDirectory().Split("src")[0] + @"\\Modules\\Watermark\\Watermark\\Resources\\WatermarkImages\\1.jpg");            
            this.TextWatermark = "DataSharp";

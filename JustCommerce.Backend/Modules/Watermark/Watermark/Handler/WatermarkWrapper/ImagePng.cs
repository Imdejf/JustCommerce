...
namespace Watermark.Handler.WatermarkWrapper
{
    ...
    /// </summary>
    internal sealed class ImagePng : WatermarkGenerator<WatermarkImageConfig>, IWatermarkHandler
    {
        public WatermarkFileType Type { get; set; } = WatermarkFileType.PNG;            
        ...
        public ImagePng(IOptions<WatermarkImageConfig> config) : base(config.Value)
        {

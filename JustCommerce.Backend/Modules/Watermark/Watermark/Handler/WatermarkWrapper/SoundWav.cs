...
{
    /// <summary>
    /// Default implementation class of <see cref="IWatermarkHandler"/> for .wav file
    /// </summary>
    internal sealed class SoundWav : WatermarkGenerator<WatermarkSoundConfig>, IWatermarkHandler
    {
        public WatermarkFileType Type { get; set; } = WatermarkFileType.WAV;
        ...
        public SoundWav(IConverterBuilder converterBuilder, IOptions<WatermarkSoundConfig> config, IWavSoundComparer wavSoundComparer, IWavSoundCutter wavSoundCutter, IWavSoundConcatenater wavSoundConcatenater, IWavSoundMixer wavSoundMixer)
            : base(config.Value)
        {
        ...
        /// <summary>
        /// Main method for adding watermark to .wav file
        /// </summary>
        /// <param name="array">
        /// Throws
        /// <list type="bullet">
        ...
        public override byte[] SetWatermark(byte[]? array)
        {
            ...
            return base.SetWatermark(array);
        }

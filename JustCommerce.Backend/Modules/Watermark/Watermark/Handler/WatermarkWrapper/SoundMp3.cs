...
{
    /// <summary>
    /// Default implementation class of <see cref="IWatermarkHandler"/> for .mp3 file
    /// </summary>
    internal sealed class SoundMp3 : WatermarkGenerator<WatermarkSoundConfig>, IWatermarkHandler
    {
        public WatermarkFileType Type { get; set; } = WatermarkFileType.MP3;
        ...
        public SoundMp3(IConverterBuilder converterBuilder, IOptions<WatermarkSoundConfig> config, IWavSoundComparer wavSoundComparer, IWavSoundCutter wavSoundCutter, IWavSoundConcatenater wavSoundConcatenater, IWavSoundMixer wavSoundMixer)
            : base(config.Value)
        {
        ...
        /// <summary>
        /// Main method for adding watermark to .mp3 file
        /// </summary>
        /// <param name="array">
        /// Throws
        /// <list type="bullet">

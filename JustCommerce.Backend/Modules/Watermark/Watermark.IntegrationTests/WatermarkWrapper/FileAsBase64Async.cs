...
{
    public class FileAsBase64Async
    {
        ServiceCollection _services;
        public FileAsBase64Async()
        {
        ...
        [Fact]
        public async void Returns_Async_File_As_Base64_If_Send_File_With_Jpg_Extension()
        {
            AddConfig();
            var provider = _services.BuildServiceProvider();
            var wrapper = provider.GetRequiredService<IWatermarkGenerator>();
        ...
        [Fact]
        public async void Returns_Async_File_As_Base64_If_Send_File_With_Pdf_Extension()
        {
            AddConfig();
            var provider = _services.BuildServiceProvider();
            var wrapper = provider.GetRequiredService<IWatermarkGenerator>();
        ...
        [Fact]
        public async void Returns_Async_File_As_Base64_If_Send_File_With_Docx_Extension()
        {
            AddConfig();
            var provider = _services.BuildServiceProvider();
            var wrapper = provider.GetRequiredService<IWatermarkGenerator>();
        ...
        [Fact]
        public async void Returns_Async_File_As_Base64_If_Send_File_With_Mp3_Extension()
        {
            AddConfig();
            var provider = _services.BuildServiceProvider();
            var wrapper = provider.GetRequiredService<IWatermarkGenerator>();
        ...
        [Fact]
        public async void Returns_Async_File_As_Base64_If_Send_File_With_Mp4_Extension()
        {
            AddConfig();
            var provider = _services.BuildServiceProvider();
            var wrapper = provider.GetRequiredService<IWatermarkGenerator>();
        ...
        [Fact]
        public async void Returns_Async_File_As_Base64_If_Send_File_With_Wav_Extension()
        {
            AddConfig();
            var provider = _services.BuildServiceProvider();
            var wrapper = provider.GetRequiredService<IWatermarkGenerator>();

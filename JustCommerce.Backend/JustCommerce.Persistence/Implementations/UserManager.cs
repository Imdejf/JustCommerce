...
namespace JustCommerce.Persistence.Implementations.CommonRepositories
{
    internal sealed class UserManager : IUserManager
    {
        ...
        public UserManager(JustCommerceDbContext justCommerceDb, UserManager<UserEntity> userManager, SignInManager<UserEntity> signInManager, RoleManager<IdentityRole<Guid>> roleManager)
        {
